function [x0,delta,out] = subpixel5x5lm(F)
% SUBPIXEL5X5LM finds highest peak position of difference measure F 
% with a 5x5 point non-linear least squares fit (Levenberg–Marquardt) 
% to bivariate Gaussian.
% 
% [x0,delta,out] = SUBPIXEL5X5LM(F)
% 
...
% 
% See also SUBPIXEL3X3LM, SUBPIXEL3X3, SUBPIXEL3X3LS, SUBPIXEL5X5LS, SUBPIXEL3X2, SUBPIXELNONE
  ...
  for k=1:kmax
    ...
    for i=1:10
        ...
        %dc = (J*W*J'+lambda*eye(7))\(J*W*(f(:)-fi));  %use weights?
        c = c + dc;
    end
